...
## Basic Usage
A detailed guide is available to view [here](https://www.hreikin.co.uk/2018/06/03/creating-an-interactive-campaign-map-with-leaflet/). Full documentation is available in the ```docs``` folder of this repository.
